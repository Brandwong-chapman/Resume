...
// /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ //
Game::Game() : m_nGridRows(k_nGridRowsDefault), m_nGridColumns(k_nGridColumnsDefault), m_iRowBoat(0), m_iColumnBoat(0), m_nTorpedoes(k_nMaxTorpedoes)/* ?? add initializers for member variables
m_iRowBoat, m_iColumnBoat, and m_nTorpedoes. ?? */
{
  initializeGrid();
...
// /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ //
/* ?? Assign '*' to value of a_cGrid at the row and column index returned
from promptForGridCoord(). ??*/
  a_cGrid[iRow][iColumn] = '*';
...
std::uniform_int_distribution<int> uniformIntegerDistributionColumns(0,
(this->m_nGridColumns - 1));
this->m_iColumnBoat =
uniformIntegerDistributionColumns(randomNumbreGenerator);
// /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ //
...
#if defined(DIAG)
std::cout << "DIAG: Boat location (Row/Column): " << this->m_iRowBoat << "; "
<< this->m_iColumnBoat << std::endl;
#endif
}
...
// /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ //
// TODO: If the target boat has not been sunk (bSunk is false), displaythe remaining number of torpedoes
...
this->initializeGrid();
#if defined TEST
// Place the target boat at a specified location for testing/diagnostic
purposes.
// This code is executed only if the TEST macro is defined (#define TEST or -
DTEST).
// If the macro is defined, the program is in "test mode."
this->placeBoat();
#else
// The target boat is placed at a random location on the grid; this is usedfor testing purposes.
// normal gameplay.
