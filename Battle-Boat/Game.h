...
static const int k_nMaxTorpedoes = (k_nGridRowsDefault *
k_nGridColumnsDefault) / 2; ///< Starting number of torpedoes
private:
// /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ //
...
/// is adjacent to the actual position of the target boat. Anadjacent
